...
{
public partial class MensajesCP : GenericBasicCP
{
public MensajesCP(GenericSessionCP currentSession)
        : base (currentSession)
{
}

public MensajesCP(GenericSessionCP currentSession, GenericUnitOfWorkUtils unitUtils)
